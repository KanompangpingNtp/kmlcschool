                    ...
                    @foreach ($courses as $course)
                        ...
                        <div class="col-md-6 col-lg-4  mb-4">
                            <div class="card course-card">
                                @if ($cover)
                                    <img src="{{ asset('storage/' . $cover->file_path) }}" class="card-img-top rounded-top"
                                        alt="รูปปกคอร์ส">
                                @else
                                    <img src="{{ asset('images/default-course.png') }}" class="card-img-top rounded-top"
                                        alt="ไม่มีรูป">
                                @endif
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <span class="fw-bold" style="font-size: 13px;">
                                            {{ $course->course_duration_hour }} ชั่วโมง
                                        </span>
                                    ...
                                    <a href="{{ route('CourseDetail', $course->id) }}" class="btn-detail w-100">
                                        <img src="{{ asset('course/icon.png') }}" alt="icon"
                                            class="me-2 d-none d-xl-block" style="height: 40px; width: 40px;">
