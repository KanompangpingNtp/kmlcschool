...
class CoursesOfferedController extends Controller
{
    public function CoursesOfferedPage()
    {
        ...
        $courses = Course::with(['subject', 'user', 'files', 'teachings', 'amountTimes'])->latest()->get();

        return view('dashboard.admin.courses_offered.page', compact('subjects', 'users', 'courses', 'courseDay'));
    }

    public function CoursesOfferedCreatePage()
    {
        $subjects = Subject::all();
        $courseDay = CourseDay::all();
        $users = User::where('level', '2')->get();
        ...
        return view('dashboard.admin.courses_offered.create', compact('subjects', 'users', 'courses', 'courseDay'));
    }

    public function CoursesOfferedUpdatePage($id)
    {
        $subjects = Subject::all();
        $courseDay = CourseDay::all();
        $users = User::where('level', '2')->get();
        ...
        return view('dashboard.admin.courses_offered.update', compact('subjects', 'courseDay', 'users', 'course'));
    }
